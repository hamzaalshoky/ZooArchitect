...
public class ZAAdvancementTrigger extends SimpleCriterionTrigger<ZAAdvancementTrigger.Instance> {
    public final ResourceLocation resourceLocation;

    public ZAAdvancementTrigger(ResourceLocation resourceLocation) {
        this.resourceLocation = resourceLocation;
    }

    public ZAAdvancementTrigger.Instance createInstance(JsonObject p_230241_1_, EntityPredicate.Composite p_230241_2_, DeserializationContext p_230241_3_) {
        return new ZAAdvancementTrigger.Instance(p_230241_2_, resourceLocation);
    }
